			...
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="container-fluid"">
					...
					<ul class="nav navbar-nav">
						<li class="active"><a href="#" class="font-rob">Login</a></li>
		...
		<div class="content-1">
			<div class="container">
				<form class="col-sm-6 daftar-member">
					...
					<div class="no-akun">
						* Belum Punya Akun ? Silahkan Daftar <a href="daftar.php" class="daftar-link-php">Disini</a>
					</div>
				</form>
			</div>
			<div class="image-work">
				<img src="../image/icon-daftar.jpg" class="image-login">
			</div>
		</div>
